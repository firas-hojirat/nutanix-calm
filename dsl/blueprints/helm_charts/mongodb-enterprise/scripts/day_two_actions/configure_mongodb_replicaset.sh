...
## The mongodb instance name will all be the namespace and ops-manager project name

MONGODB_REPLICASET_INSTANCE_NAME="@@{mongodb_replicaset_instance_name}@@"

OM_PROJECT_NAME="${MONGODB_REPLICASET_INSTANCE_NAME}"
