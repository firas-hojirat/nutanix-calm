...
variable "common_content_library_skip_import" {
  type        = bool
  description = "Skip importing the virtual machine to the content library. Option allows for testing / debugging without saving the machine image."
  default     = false
}
...
variable "iso_urls" {
  type        = list(string)
  description = "List of ISO URLs to download and mount to VM"
  default     = []
}
