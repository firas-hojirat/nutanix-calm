...
locals {
  ...
  iso_paths         = [
    ...
    "[${var.common_iso_datastore}] /iso/windows/pe/vsphere-win10-wim.iso"
  ]
  ...
  vm_name           = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition}-v${local.build_version}-alpha"
}
